...
<div class="container paddingT75">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="add-margin-cqu-color-dark">Contact Us</h3>
            <br>
            <div class="row">
            <h2 class="contact-subheading">Your Personal Detail</h2>
                <form role="form" method="post" action="<?=base_url();?>index.php/contact/contact_form">
                    ...
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control custom-text" name="lastname" id="name" placeholder="Your Last Name *" required>
                    </div>
                    <div class="form-group col-md-6">
